...
public class CursorAdapterMentor extends CursorAdapter{


    public CursorAdapterMentor(Context context, Cursor cursor){
    ...
    public void bindView(View view, Context context, Cursor cursor) {
        ...
        mentorID.setText(cursor.getString(cursor.getColumnIndexOrThrow(DBOpenHelper.TABLE_ID)));
    }
}
